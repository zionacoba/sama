  ...
  try {
    await resend.emails.send({
      ...
      html: `
        ...
        <p>Your platform fee is <strong>${commissionRatePercent}%</strong> per booking. Payouts are sent to your preferred payout method. We do a payout run every Wednesday.</p>
