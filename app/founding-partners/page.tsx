...
export const metadata: Metadata = {
  ...
  description:
    "You've been personally invited to join Sama as a Founding Partner. 20 spots. 5% for life. Closes September 30, 2026.",
  openGraph: {
...
const terms = [
  ...
  { label: "Deadline", value: "September 30, 2026" },
        ...
        <section className="relative bg-trailhead px-4 pb-24 pt-32 text-center sm:pb-32 sm:pt-40">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-white/80">
              20 spots. 5% platform fee, locked in for life. Closes September 30, 2026.
            </p>
          </div>
        </section>
