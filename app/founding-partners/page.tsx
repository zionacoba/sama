...
export const metadata: Metadata = {
  ...
  description:
    "You've been personally invited to join Sama as a Founding Partner. 20 spots. 5% for life. Closes October 31, 2026.",
  openGraph: {
...
const terms = [
  ...
  { label: "Deadline", value: "October 31, 2026" },
      ...
      <main className="flex-1">
        ...
        <section className="relative bg-trailhead px-4 pb-24 pt-32 text-center sm:pb-32 sm:pt-40">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-white/80">
              20 spots. 5% platform fee, locked in for life. Closes October 31, 2026.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-3xl px-6 py-10 sm:px-4 sm:py-16">
          ...
          <p className="mt-4 text-sm text-stone-600">
            Your founding rate stays at 5% as long as you keep to the organizer terms. The only exception is if GCash or Maya raise their fees.
          </p>
        </section>
