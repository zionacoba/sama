        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm sm:p-10">
          ...
          <div className="mt-8 space-y-8 text-stone-600">
            ...
            <section>
              ...
              <p className="mt-2 leading-relaxed">
                We retain your personal data for as long as your account is active or as required by law. Personal data associated with cancelled bookings is retained for record-keeping purposes. You may request deletion of your personal data at any time by deleting your account or contacting <a href="mailto:hello@sama.com.ph">hello@sama.com.ph</a>. Booking and payment records, including consent and waiver records, are retained for a minimum of 5 years for legal, financial, and dispute resolution purposes.
              </p>
              <p className="mt-3 leading-relaxed">
                Health information (medical notes and allergies) and emergency-contact information are used only to support participant safety for a booked trip. This sensitive data is kept for a shorter retention period than the rest of the booking record: it is automatically deleted 90 days after the trip ends. The surrounding booking, payment, consent, and waiver records are retained for the longer legal and financial period described above, but the health and emergency-contact fields within them are permanently stripped once the 90-day window passes. This is why a booking record may persist for up to 5 years while its medical notes and emergency-contact details do not.
              </p>
              <p className="mt-3 leading-relaxed">
