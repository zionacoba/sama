          ...
          <div className="mt-8 space-y-8 text-stone-600">
            ...
            <section>
              ...
              <ul className="mt-1.5 space-y-1 leading-relaxed">
                ...
                <li className="flex gap-2"><span className="mt-1 shrink-0 text-stone-400">•</span><span>Payout details (bank account or GCash number) used to remit your earnings.</span></li>
