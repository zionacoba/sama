-- Fix: p_participants was declared text[] but bookings.participants is jsonb.
-- PostgreSQL cannot implicitly cast text[] to jsonb, causing all multi-slot bookings
-- (or any booking that passes participants) to fail with error 42804.
